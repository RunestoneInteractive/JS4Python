...
project = 'JavaScript for Python Programmers'
...
html_theme_options = {
    ...
    'navbar_title': "JavaScript for Python Programmers",
...
html_title = 'JavaScript 4 Python Programmers'
shelf_section = "Language Transition"
